...
const en: Translations = {
  ...
  "generator.subtitle": "Paste an AliExpress product link to generate your affiliate link.",
  "generator.inputLabel": "Product Link",
  "generator.inputPlaceholder": "https://www.aliexpress.com/item/...",
  "generator.trackingId": "Tracking ID",
  "generator.trackingIdPlaceholder": "Enter tracking ID",
  "generator.trackingIdNote": "Set your Tracking ID in Settings to auto-fill this field.",
  ...
  "generator.errorEmpty": "Please enter a product link.",
  "generator.errorInvalid": "The link does not appear to be a valid AliExpress product URL.",
  "generator.errorApi": "Failed to generate link. Please try again.",
  "generator.errorNoResult": "No affiliate link returned. Check your credentials.",
  ...
  "settings.enterTrackingId": "Enter your Tracking ID",
  "settings.trackingIdHelper": "Optional. Used to identify traffic from your links.",
};
...
const ar: Translations = {
  ...
  "generator.subtitle": "الصق رابط منتج من AliExpress لإنشاء رابط الأفلييت الخاص بك.",
  "generator.inputLabel": "رابط المنتج",
  "generator.inputPlaceholder": "https://www.aliexpress.com/item/...",
  "generator.trackingId": "معرّف التتبع (Tracking ID)",
  "generator.trackingIdPlaceholder": "أدخل معرّف التتبع",
  "generator.trackingIdNote": "قم بإعداد معرّف التتبع في الإعدادات ليتم ملؤه تلقائياً.",
  ...
  "generator.errorEmpty": "الرجاء إدخال رابط المنتج.",
  "generator.errorInvalid": "لا يبدو أن الرابط عنوان URL صالح لمنتج AliExpress.",
  "generator.errorApi": "فشل إنشاء الرابط. يرجى المحاولة مرة أخرى.",
  "generator.errorNoResult": "لم يُعد رابط أفلييت. تحقق من بيانات الاعتماد.",
  ...
  "settings.trackingId": "معرّف التتبع",
  "settings.enterTrackingId": "أدخل معرّف التتبع",
  "settings.trackingIdHelper": "اختياري. يُستخدم لتحديد الزيارات من روابطك.",
};
