...
const en: Translations = {
  ...
  "generator.subtitle": "Select a tracking ID, paste a product link, and generate your affiliate link.",
...
const ar: Translations = {
  ...
  "generator.subtitle": "اختر معرّف التتبع، ثم الصق رابط المنتج لإنشاء رابط الأفلييت.",
